...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/intake-astro-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/intake-astro-feedstock)
...
Once the `conda-forge` channel has been enabled, `intake-astro` can be installed with:

```
conda install intake-astro
```

It is possible to list all of the versions of `intake-astro` available on your platform with:
